...
- `Stage 02 // Storm Front`：已打磨为可展示的第二关，强化侧压、屏障火力和更重的 Boss 压迫
- `Chapter Run`：`Stage 01 -> Stage 02` 的双关章节流，用于验证资源继承和更长短流程的成立性

## 当前版本定位

- 当前状态：双关可展示原型，已完成单局展示与章节串联验证
- 开发阶段：已完成“最小可玩验证”“展示可读性强化”“视听反馈强化”“第二关骨架验证”和“双关章节串联验证”，正在向“垂直切片早期”推进
- 当前重点：继续深化第二关差异、抬高章节演出完成度，并评估是否进入更完整的双关垂直切片
