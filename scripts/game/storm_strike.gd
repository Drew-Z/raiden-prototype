...
func _ready() -> void:
	...
	collision_shape.position = Vector2(0.0, screen_rect.position.y + screen_rect.size.y * 0.5)
...
func _draw() -> void:
	var beam_rect := Rect2(Vector2(-beam_half_width, screen_rect.position.y), Vector2(beam_half_width * 2.0, screen_rect.size.y))
	if not active:
		...
		draw_line(Vector2(0.0, screen_rect.position.y), Vector2(0.0, screen_rect.end.y), Color(1.0, 0.94, 0.72, 0.7), 2.0)
		draw_rect(Rect2(Vector2(-beam_half_width - 6.0, screen_rect.position.y), Vector2(beam_half_width * 2.0 + 12.0, screen_rect.size.y)), Color(0.88, 0.5, 0.18, 0.08 + pulse * 0.25), false, 3.0)
	else:
		...
		draw_line(Vector2(0.0, screen_rect.position.y), Vector2(0.0, screen_rect.end.y), Color(1.0, 1.0, 1.0, 0.9), 5.0)
		draw_rect(Rect2(Vector2(-beam_half_width - 10.0, screen_rect.position.y), Vector2(beam_half_width * 2.0 + 20.0, screen_rect.size.y)), Color(0.7, 0.92, 1.0, 0.22), false, 4.0)
